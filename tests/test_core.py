...
from target_dualentry.target import TargetDualentry
...
StandardTargetTests = get_target_test_class(
    target_class=TargetDualentry,
    config=SAMPLE_CONFIG,
)


class TestTargetDualentry(StandardTargetTests):  # type: ignore[misc, valid-type]  # noqa: E501
